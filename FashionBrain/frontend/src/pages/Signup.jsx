...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Handle immediate success - check response data directly
      if (result?.access_token) {
        // Ensure token is saved
        localStorage.setItem('token', result.access_token);
        
        // Check if user needs onboarding based on response
        const onboardingStatus = result?.user?.onboarding_completed;
